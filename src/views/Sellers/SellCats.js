              ...
              <div className="row switch-pane" style={{ marginBottom: '10px' }}>
                <div className="col-12 col-lg-8 ml-auto mr-auto m">
                  <div className="multisteps-form__progress">
                    ...
                    <button className="multisteps-form__progress-btn" type="button">Choisir un article</button>
              ...
              <div className="multisteps-form__content">
                <div className="card-list">
                  {categories.map(category => (
                    <Link key={category._id} className="small-app-card" to={`/seller/sell/arts/${category._id}`}>
                      {category.name}
                    </Link>
                  ))}
                </div>
                <table className="container mb-4">
                  <tbody>
                    <tr className="row">
                      <td className="col"></td>
                      <td className="col"></td>
                      <td className="col"><strong>Total: </strong></td>
                      <td className="col"><strong>0 DHS</strong></td>
                    </tr>
                  </tbody>
                </table>
                <div className="button-row d-flex mt-4">
                  <button className="flat-btn-small btn-red">Annuler</button>
                  <button className="ml-auto flat-btn-small btn-blue">Terminé</button>
                </div>
              </div>
            </div>
          </div>
